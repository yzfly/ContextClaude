...
> 本文档详细介绍 ContextClaude 的系统架构、设计理念和技术实现。
...
ContextClaude 以 markdown 文档驱动的 AI 编程为核心，文档作为 Claude Code 的上下文驱动生成代码，文档作为项目的知识库，文档的内容作为项目的上下文。
...
**本架构文档持续更新中，如有疑问请参考 [项目主页](https://github.com/yzfly/ContextClaude) 或提交 Issue。**